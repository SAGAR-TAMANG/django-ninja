...
@app.post("devices/", response={200: DeviceCreateSchema, 404: Error})
def create_device(request, device: DeviceCreateSchema):
    if device.location_id:
        # Locaiton ID is present
...
def update_device_location(requset, device_slug, location: DeviceLocationPatch):
